...
const DOB = route.params?.DOB || '09 September 2005';
...
const navigateToContactInfo = () => {
  ...
  Meta uses this information to verify your identity and to keep our community safe. You decide what personal details you make visible to others.
        ...
        <TouchableOpacity onPress={navigateToContactInfo}>                   
                   <View style={styles.row}>
                    <View rowTextContainer>
                    ...
                    <Text style={styles.profileAddress}>{Email}</Text> 
                     ...
                     <View style={styles.rowSpacer} /> 
                       <FeatherIcon
                         color="#ababab"
                         name="chevron-right"
                         size={22}  onPress={navigateToContactInfo}
         ...
         <TouchableOpacity onPress={navigateToLikesNComments}>                   
                    ...
                    <View rowTextContainer>
                      ...
                      <Text style={styles.profileAddress}>{DOB}</Text> 
                      </View>
                      <View style={styles.rowSpacer} />                      
                        <FeatherIcon
                          color="#ababab"
         ...
         <TouchableOpacity  onPress={navigateToLikesNComments}>                   
                    ...
                    <View rowTextContainer>
                      ...
                      <Text style={styles.profileAddress}>Manage your data, modify your legacy contact,{'\n'} and deactivate or delete your accounts and profiles.</Text> 
                      </View>
                      <View style={styles.rowSpacer} />      
