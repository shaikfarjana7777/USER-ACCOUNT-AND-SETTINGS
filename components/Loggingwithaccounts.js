  ...
  return (
    ...
    <SafeAreaView >
      <View style={styles.headingContainer}>
        ...
        <Text style={styles.heading}>Logging in with Accounts</Text>
      </View>


      <View style={styles.spacing}>
  <Text style={styles.rowValue1}>
Add your accounts to enable connected experiencesb ,  {'\n'} 
such as logging in with Synthiem , Facebook or Instagram  </Text>
</View>
...
export default Loggingwithaccounts;
