...
const navigateToLikesNComments = () => {
  ...
  Manage your mobile numbers and email addresses to make sure that your contact info is accurate and up to date. </Text>
</View>
        ...
        <TouchableOpacity onPress={navigateToemail}>                   
                    ...
                    {/* <Text style={styles.profileAddress}></Text>  */}
                     ...
                     <View style={styles.rowSpacer} /> 
                       <FeatherIcon
                         color="#ababab"
                         name="chevron-right"
                         size={22}  onPress={navigateToemail}
         ...
         <TouchableOpacity  onPress={navigateToLikesNComments}>                   
                    <View style={styles.row}>
                    <View rowTextContainer>
                      <Text style={styles.txt}>Add more account</Text>
